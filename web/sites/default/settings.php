 ...
 * @endcode
 */
$settings['hash_salt'] = 'kJa4709768^*(&LAKSJFLSKJFlsLFJDHFL(*&$30JDFlsjfhlsdjhLASJHDlj(*&(#43)fehgrkuwsFgr';
 ...
 */
$settings['trusted_host_patterns'] = ['^sdd\.ti\-work\.ru$'];
/**
